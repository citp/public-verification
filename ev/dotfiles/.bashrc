...
export PS1="[ \[$(tput sgr0)\]\[\033[38;5;$(whoami | sum | awk '{print ($1 % 256)}')m\]\u\[$(tput sgr0)\]@\[$(tput sgr0)\]\[\033[38;5;$(hostname | sum | awk '{print ($1 % 256)}')m\]\h\[$(tput sgr0)\]:\[$(tput sgr0)\]\[\033[38;5;$(pwd | sum | awk '{print ($1 % 255)}')m\]\w\[$(tput sgr0)\] ]\\$ \[$(tput sgr0)\]"
